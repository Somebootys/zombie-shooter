...
use crate::{
    components::{
        Alive, ColliderSquare, Enemy, EnemyCount, GameTextures, Health, Player, ARENA_SIZE,
        ENEMY_BOOMER_SPRITE_SIZE, ENEMY_CRAWLER_SPRITE_SIZE, ENEMY_ZOOMER_SPRITE_SIZE,
...
pub fn spawn_horde_of_enemies(
    ...
    let width = (ARENA_SIZE - TILE_SIZE) / 2.0;
    let height = (ARENA_SIZE - TILE_SIZE) / 2.0;
    let off_set = 25.0;
