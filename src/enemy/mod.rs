...
use crate::{
    components::{
        ColliderSquare, Enemy, EnemyCount, Health, Player, ENEMY_BOOMER_SPRITE_SIZE, MAX_NUM_ENEMIES, ENEMY_CRAWLER_SPRITE_SIZE, ENEMY_ZOOMER_SPRITE_SIZE,
        TYPES_OF_ENEMIES, GameTextures,
    },
...
pub fn spawn_horde_of_enemies(
    ...
    if enemy_count.0 < MAX_NUM_ENEMIES {
        ...
        let array = [game_textures.enemy_boomer.clone(), game_textures.enemy_crawler.clone(), game_textures.enemy_zoomer.clone()];
        let array_sprite_size = [ENEMY_BOOMER_SPRITE_SIZE, ENEMY_CRAWLER_SPRITE_SIZE, ENEMY_ZOOMER_SPRITE_SIZE];
