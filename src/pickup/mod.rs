use crate::components::{ColliderSquare, GameTextures, Health, PickUp, PickUpTimer,PickUpDuration, PICK_UP_DURATION,WinSize, Player};
use bevy::prelude::*;
...
pub fn spawn_pickup(mut cmd: Commands, game_textures: ResMut<GameTextures>, 
    ...
    if puckup_timer.time.tick(time.delta()).just_finished() {
        ...
        cmd.spawn((
            ...
            PickUpDuration {time: Stopwatch::new()},
        ));
